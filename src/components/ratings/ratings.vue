<template>
  <div class="ratings" ref="ratingsWrapper">
    <div class="ratings-content">
      ...
      <split></split>
      <ratingselect :select-type="selectType" :only-content="onlyContent" :desc="desc" :ratings="ratings" @ratingtypeSelect="ratingSelect" @contentToggle="contentToggle"></ratingselect>
